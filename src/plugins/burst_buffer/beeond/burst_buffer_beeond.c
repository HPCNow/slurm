/*****************************************************************************\
 *  burst_buffer_beeond.c - BeeOND library for managing a burst_buffer
 *****************************************************************************
 *  Copyright (C) 2014-2015 SchedMD LLC.
 *  Written by Morris Jette <jette@schedmd.com>
 *  This plugin is developed by Jordi Blasco <jordi.blasco@hpcnow.com>
 *  Based on burst_buffer_generic.c and includes additional features to
 *  accomodate BeeOND requirements.
 *
...
/*
 * These variables are required by the beeond plugin interface.  If they
 ...
 */
const char plugin_name[]        = "burst_buffer beeond plugin";
const char plugin_type[]        = "burst_buffer/beeond";
